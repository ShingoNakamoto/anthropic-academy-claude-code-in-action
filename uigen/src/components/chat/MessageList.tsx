  ...
  if (messages.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-full px-4 text-center">
        ...
        <p className="text-neutral-900 font-semibold text-lg mb-2">会話を始めてReactコンポーネントを生成しましょう</p>
        <p className="text-neutral-500 text-sm max-w-sm">ボタン、フォーム、カードなどの作成をお手伝いします</p>
      </div>
    );
  }
                          ...
                          case "reasoning":
                            return (
                              <div key={partIndex} className="mt-3 p-3 bg-white/50 rounded-md border border-neutral-200">
                                <span className="text-xs font-medium text-neutral-600 block mb-1">推論</span>
